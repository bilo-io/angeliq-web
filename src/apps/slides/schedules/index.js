...
import helpCreate from 'img/help/schedules_create.gif'
import helpEventCreate from 'img/help/schedules_event_create.gif'
import helpActions from 'img/help/schedules_actions.gif'
import './control-slot'
                        ...
                        schedule
                            ...
                            : <div className='padded  flex-row' style={{ position: 'relative', height: 'calc(100vh - 6rem)' }}>
                                <div id={'guide'}>
                                    ...
                                    <p>
                                        Schedules allow you to play specific <Link to='/slides/slides/'>Slideshows</Link> at certain times
                                        <br />
